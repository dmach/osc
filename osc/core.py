...
class Serviceinfo:
    ...
    def _execute(self, dir, old_dir, callmode: Optional[str] = None, singleservice=None,
...
class Project:
    ...
    @staticmethod
    def init_project(apiurl: str, dir, project, package_tracking=True, getPackageList=True, progress_obj=None, wc_check=True, scm_url=None):
        global store
...
def make_dir(apiurl: str, project: str, package: str, pathname=None, prj_dir=None, package_tracking=True, pkg_path=None):
    """
...
def checkout_package(apiurl: str, project: str, package: str,
...
def delete_comment(apiurl: str, cid: str):
